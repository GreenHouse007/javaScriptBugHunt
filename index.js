...
// ALEX: added missing closing parenthesis
console.log(message);
...
// ALEX: added declaration of myVariable
...
// ALEX: added the console.log function to show the value data type for greeting
...
*/
// ALEX: added a property object to obj variable
let obj = { property: "color" };
...
// ALEX: added different ways to log the user object
console.log("Example 1: User info: ", user);
//or
console.log(`Example 2: User info: ${JSON.stringify(user)}`);
//or
console.log(`Example 3: User info: Name - ${user.name},  Age - ${user.age}`);
...
*/
// ALEX: removed the "" from the number to show a number rather then a string
let num = 10;
